...
<!-- 📸 强烈建议在这里放一张主界面截图，或一段「出征」过程的 GIF：放到 docs/ 后用  ![点将台](docs/screenshot.png)  引用。
     视觉元素是 README 性价比最高的部分——能让访客 3 秒看懂产品。这是目前最该补的一块。 -->
> 📸 _界面截图 / 出征 GIF 待补——见上方注释处，这是让访客一眼看懂产品的最佳位置。_
